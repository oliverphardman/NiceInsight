...
document.open();
var insertHTML = `
<link src="` + chrome.extension.getURL("foundation.css") + `" rel="stylesheet">
<link src="` + chrome.extension.getURL("fixinsight.css") + `" rel="stylesheet">
<div class="row align-middle">
    <div class="small-2 large-4 columns"></div>
  <div class="small-8 large-4 columns" id="loginpanel"><br>
  <img id="insightlogo" src="` + chrome.extension.getURL("img/insight.png") + `">
  <div id="` + errordisp + `"><b><p id="errorText"></p></b></div><br>
  <form method="POST" action="secure.aspx" id="insightlogin" onsubmit="ShowSpinner();">
  	<input type="text" class="fields" name="UserName" id="usernameField" placeholder="Username">
  	<input type="password" class="fields" name="Password" id="passwordField" placeholder="Password">
